        ...
        .then(profile => {
            if(profile){
                ...
                Profile.findOne({ handle: profileFields.handle }).then(profile => {
                   if(profile){
                     errors.handle = "that profile already exist"; 
...
//@Route    api/profile/experience/:exp_id DELETE request
...
//@Route    api/profile/education/:edu_id DELETE request
